...
ActiveRecord::Schema[7.1].define(version: 2024_06_14_024349) do
  ...
  create_table "userGameDatas", primary_key: ["user_id", "level_id"], force: :cascade do |t|
    t.integer "user_id"
    t.integer "level_id"
    t.integer "userLevelScore"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["level_id"], name: "index_userGameDatas_on_level_id"
    t.index ["user_id"], name: "index_userGameDatas_on_user_id"
  end
  ...
  add_foreign_key "userGameDatas", "levels"
  add_foreign_key "userGameDatas", "users"
end
